  ...
  switch (theme) {
    case THEME_2.NONE: {
      ...
      function draw() {
        ...
        ctx.fillStyle = 'rgba(192, 246, 251, 1)'
        ctx.beginPath()
        for (let i = 0; i < mp; i++) {
          const p = particles[i]
          ctx.moveTo(p.x, p.y)
...
export const BackgroundSwitch = () => {
  ...
  let soundOn = undefined
  let soundOff = undefined
  if (typeof Audio != 'undefined') {
    soundOn = new Audio(switchOnSound)
    soundOff = new Audio(switchOffSound)
  }
